...
class VisitorsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create visitor" do
    assert_difference('Visitor.count') do
      post visitors_url, params: { visitor: { cpf: @visitor.cpf, description: @visitor.description, genre: @visitor.genre, photo: @visitor.photo, telephone: @visitor.telephone } }
    end
  ...
  test "should update visitor" do
    patch visitor_url(@visitor), params: { visitor: { cpf: @visitor.cpf, description: @visitor.description, genre: @visitor.genre, photo: @visitor.photo, telephone: @visitor.telephone } }
